...
let MemoryService = (() => {
    ...
    return class MemoryService extends _classSuper {
        static {
            ...
            _evolve_decorators = [Remote('evolve')];
            ...
            __esDecorate(this, null, _runDeletionFeedback_decorators, { kind: "method", name: "runDeletionFeedback", static: false, private: false, access: { has: obj => "runDeletionFeedback" in obj, get: obj => obj.runDeletionFeedback }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _getDeletionFeedback_decorators, { kind: "method", name: "getDeletionFeedback", static: false, private: false, access: { has: obj => "getDeletionFeedback" in obj, get: obj => obj.getDeletionFeedback }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _humanArchiveExperience_decorators, { kind: "method", name: "humanArchiveExperience", static: false, private: false, access: { has: obj => "humanArchiveExperience" in obj, get: obj => obj.humanArchiveExperience }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _evolve_decorators, { kind: "method", name: "evolve", static: false, private: false, access: { has: obj => "evolve" in obj, get: obj => obj.evolve }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _generateSkillDraft_decorators, { kind: "method", name: "generateSkillDraft", static: false, private: false, access: { has: obj => "generateSkillDraft" in obj, get: obj => obj.generateSkillDraft }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _reviewSkill_decorators, { kind: "method", name: "reviewSkill", static: false, private: false, access: { has: obj => "reviewSkill" in obj, get: obj => obj.reviewSkill }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _publishSkill_decorators, { kind: "method", name: "publishSkill", static: false, private: false, access: { has: obj => "publishSkill" in obj, get: obj => obj.publishSkill }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _listSkillArtifacts_decorators, { kind: "method", name: "listSkillArtifacts", static: false, private: false, access: { has: obj => "listSkillArtifacts" in obj, get: obj => obj.listSkillArtifacts }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _getSkillArtifact_decorators, { kind: "method", name: "getSkillArtifact", static: false, private: false, access: { has: obj => "getSkillArtifact" in obj, get: obj => obj.getSkillArtifact }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _isSkillCandidate_decorators, { kind: "method", name: "isSkillCandidate", static: false, private: false, access: { has: obj => "isSkillCandidate" in obj, get: obj => obj.isSkillCandidate }, metadata: _metadata }, null, _instanceExtraInitializers);
...
请总结成提取反馈规则。`;
        ...
        async generateSkillDraft(agent, request) {
            ...
            if (experience === undefined)
                throw new Error(`memory: experience not found: ${request.experienceId}`);
            const content = await this.generateSkillContentWithLlm(agent, experience, request.form);
            if (content.length === 0)
                throw new Error('memory: LLM generated empty skill content');
        ...
        publishSkill(agent, request) {
            ...
            if (artifact === undefined)
                throw new Error(`memory: skill artifact not found: ${request.id}`);
            if (artifact.draftPath === undefined)
                throw new Error('memory: skill artifact has no draft path');
            const home = process.env.DSH_HOME ?? join(process.cwd(), '.dsh');
        ...
        listSkillArtifacts(agent, parentExperienceId, status) {
            ...
            if (parentExperienceId !== '')
                filter.parentExperienceId = parentExperienceId;
            if (status !== '')
